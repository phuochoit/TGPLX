...
import { colormenu, colorstatusBarProps} from "./style";
...
export const ThemeHeader = ({
    ...
    toolbarBtnColor: "#fff",
    toolbarHeight: platform === "ios" ? (isIphoneX ? 88 : 64) : 45,
    toolbarIconSize: platform === "ios" ? 18 : 20,
    toolbarSearchIconSize: platform === "ios" ? 17 : 20,
    toolbarInputColor: "#fff",
    searchBarHeight: platform === "ios" ? 30 : 30,
    toolbarInverseBg: "#fff",
    toolbarTextColor: "#fff",
    toolbarDefaultBorder: colormenu,
    iosStatusbar: "light-content",
    get statusBarColor() {
        return color(colorstatusBarProps);
    }
});
...
export const babyTab = ({
    ...
    topTabActiveBgColor: platform === "ios" ? "#cde1f9" : 'transparent',
